...
void handler (cv::Mat _image, ros::NodeHandle nh)
{
    ...
    image_transport::Publisher _image_pub = it.advertise(TOPIC_NAME_IMAGE, 20);   
    ros::Publisher _cartesian_pub = nh.advertise<geometry_msgs::Pose>(TOPIC_NAME_CARTESIAN, 20);
    ros::Publisher _finded_pub = nh.advertise<std_msgs::Bool>(TOPIC_NAME_FINDED, 20);
